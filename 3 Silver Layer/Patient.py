...
# MAGIC
# MAGIC -- Step 1: Use the fixed MERGE statement
...
# MAGIC     target.DOB <> TO_DATE(source.DOB, 'M/d/yyyy') OR
...
# MAGIC     source.Gender,
# MAGIC     TO_DATE(source.DOB, 'M/d/yyyy'),
...
# MAGIC SET spark.sql.ansi.enabled = false;
# MAGIC
# MAGIC -- Step 1: MERGE to insert new records into the Delta table
# MAGIC MERGE INTO silver.patients AS target
# MAGIC USING quality_checks AS source
# MAGIC ON target.Patient_Key = source.Patient_Key
# MAGIC AND target.is_current = true 
